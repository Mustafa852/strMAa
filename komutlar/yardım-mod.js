...
.addField("<a:ayars:731479176904704060> uyarılar <@kullanıcı>" , "» Kullanıcının Uyarılarını Gösterir!")
.addField("<a:ayars:731479176904704060> uyarı-kaldır <@kullanıcı>" , `» Kullanıcının Uyarılarını Kaldırır!
